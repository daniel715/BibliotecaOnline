...
//        Map<String, Object> salida = this.autorRepository.findAll();
...
//        Map<String, Object> response = autorRepository.save(Optional.of(autor));
//
...
//    public void canSave() {
//        Autor autor = new Autor("001", "Daniel");
//        Collection<Object> response = autorRepository.save(Optional.of(autor));
//
